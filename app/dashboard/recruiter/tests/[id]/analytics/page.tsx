        ...
        <div className="w-full px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400">Coding Test Analytics · Live</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" className="h-8 gap-1.5 text-xs bg-purple-600 hover:bg-purple-700 text-white"
              onClick={() => router.push(`/dashboard/recruiter/tests/${testId}/assign`)}>
              <Users className="h-3.5 w-3.5" />Assign Test
            </Button>
          </div>
        </div>
      </div>
